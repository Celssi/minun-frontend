...
import { NgBusinessHoursDaySettings } from './business-hours-day-settings.model';
  ...
  providers: [
    {
      ...
      multi: true,
      useExisting: forwardRef(() => BusinessHoursComponent)
    },
    {
...
export class BusinessHoursComponent implements OnInit, OnDestroy, ControlValueAccessor, Validator {
